...
from transformers import get_linear_schedule_with_warmup, MultiModalStructAdaptFastRoberta_v2_alter, AdamW
...
model = MultiModalStructAdaptFastRoberta_v2_alter(args)
...
def calc_params(params):
    ...
    Init_Model(ar)
    model = MultiModalStructAdaptFastRoberta_v2_alter(ar)
...
def new_model(adapt = '86', hid='300'):
    ...
    Init_Model(a13)
    model = MultiModalStructAdaptFastRoberta_v2_alter(a13)

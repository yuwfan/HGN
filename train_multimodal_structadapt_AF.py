...
from transformers import get_linear_schedule_with_warmup, AdamW, MultiModalStructAdaptRoberta_AF
...
run = neptune.init(tags=["StructAdapt-fast", "MultiModal"])
...
model = MultiModalStructAdaptRoberta_AF(args)

...
from .modeling_MM_bert_v1_base import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModal_Roberta_v1_base(nn.Module):
    def __init__(self, config):
        super(MultiModal_Roberta_v1_base, self).__init__()     

...
class BertLayer(nn.Module):
    ...
    def forward(
        ...
        #### intermediate
        ###### text
        intermediate_output_text = self.intermediate(attention_output)
        layer_output_text = self.output(intermediate_output_text, attention_output)
        ###### graph
        intermediate_output_graph = self.intermediate(attention_output)
        layer_output_graph = self.output(intermediate_output_graph, attention_output)

...
from .modeling_multimodal_struct_gated_v4_3 import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptRobertaGated_v4_3(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptRobertaGated_v4_3, self).__init__()     

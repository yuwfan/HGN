...
from .modeling_multi_struct_Bert_AF import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptRoberta_AF(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptRoberta_AF, self).__init__()     

...
from .modeling_structadapt_multimodal_fast_bert_v2_sum import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptFastRoberta_v2_sum(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptFastRoberta_v2_sum, self).__init__()     

...
from .modeling_structadapt_multimodal_fast_bert_v2_woBoAd import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptFastRoberta_v2_woBoAd(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptFastRoberta_v2_woBoAd, self).__init__()     

...
from .modeling_structadapt_multimodal_fast_bert_v2_woBoAd_wt import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptFastRoberta_v2_woBoAd_wt(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptFastRoberta_v2_woBoAd_wt, self).__init__()     

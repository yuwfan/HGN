...
from .modeling_structadapt_multimodal_fast_bert_v2_woGraph import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptFastRoberta_v2_woGraph(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptFastRoberta_v2_woGraph, self).__init__()     

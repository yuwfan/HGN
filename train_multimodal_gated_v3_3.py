...
from transformers import get_linear_schedule_with_warmup, MultiModalStructAdaptRobertaGated_v3_3, AdamW
...
model = MultiModalStructAdaptRobertaGated_v3_3(args)

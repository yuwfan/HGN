...
from transformers import get_linear_schedule_with_warmup, MultiModalStructAdaptFastRoberta_v2_woBoAd, AdamW
...
model = MultiModalStructAdaptFastRoberta_v2_woBoAd(args)
...
def calc_params(params):
    ...
    Init_Model(ar)
    model = MultiModalStructAdaptFastRoberta_v2_woBoAd(ar)
...
def new_model(adapt = '86', hid='300'):
    ...
    Init_Model(a13)
    model = MultiModalStructAdaptFastRoberta_v2_woBoAd(a13)
...
# Init_Model(a34)
# # 3.) Create model
# model = MultiModalStructAdaptFastRoberta_v2_woBoAd(a34)
# # 4.) Output parameters
